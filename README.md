# Celo Token Creation Tool

A simple frontend tool to create tokens on the Celo (CELO) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Celo-Token-Creation-Tool.git
- And press deploy
- Congrats your Celo Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Celo-Token-Creation-Tool
- Upload into your Github repo.
- Edit the file public/config.json and insert your Celo wallet address for receiving fees. Also set fee in CELO that you want to charge
